r"""Print the capability mapping as a table, for docs/capability-reference.md.
...
The point is that the table cannot drift: it is generated from the mapping
rather than kept alongside it. Regenerate after touching capability.py or
model.py:

    python3 scripts/dump_capability_map.py > docs/capability-reference.md

Home Assistant is imported, so run it in the test venv (see CLAUDE.md).
"""
...
def main():
    ...
    print("<!-- Generated by scripts/dump_capability_map.py. Do not edit by hand. -->")
